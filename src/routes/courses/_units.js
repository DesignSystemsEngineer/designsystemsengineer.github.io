    ...
    lessons: [
      {
        ...
        duration: 'PT10M2S',
        description: "Let's create the first component. We'll take a sprite sheet design file and create the CSS for the component in CodePen. This will allow us to get started very quickly without having to worry about setting up dev environments. We can even distribute the components and nest them.",
      },
      {
        slug: 'dse-button-css-activity',
        title: "DSE Button CSS Activity",
        duration: 'PT1M49S',
        description: "Time to fly solo for a bit. Now that you've gone through the process of making a simple component, how would you extend it to a Call To Action variant (emphasized). I've set up a starting CodePen for you to get started, and if you get stuck we can look through it together in the next video. I've also included the solution if you don't know where to start.",
      },
      {
    ...
    lessons: [
      {
        ...
        title: "DSE Button CSS",
        duration: 'PT10M2S',
        description: "Let's create the first component. We'll take a sprite sheet design file and create the CSS for the component in CodePen. This will allow us to ",
      },
      {
        slug: 'dse-button-css-activity',
        title: "DSE Button CSS Activity",
